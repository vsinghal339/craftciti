...
import { deleteTweetAction,setId } from '../actions/auth.actions';
			...
			<View style={container}>
				...
				<ActionSheet
					...
					onPress={index => {
						...
						if (index === 2) {
							this.props.setId( {id:this.id} );
							navigation.navigate('editTweet',{id:this.id});
						}
					}}
				/>
			</View>
...
export default connect(
	mapStateToProps,
	{ fetchTweetAction, deleteTweetAction,setId }
)(NewsFeed);
